...
#: machine has
#:     OCIO=/Users/artist/color/ocio/aces_2.0/config.ocio  (may_aces-v2.0-baked)
...
def expand_reference(parm, pattern, expand, exists=os.path.exists, isdir=os.path.isdir,
    ...
    * ``hou.text.expandString(pattern)`` -- what the *string* means.
    ...
    ``/Users/artist/Downloads/airship_v06.fbx#Airship_fullBindings,convertoff``
...
def _ext_suffix(path):
    ...
    cleanly (e.g. ``/Users/artist/lib/b.abc`` -> ``/Users/artist/lib/b.abc``).
