...
- **SSH Access**: `ssh -o StrictHostKeyChecking=no root@10.0.0.10`
...
- **URL**: http://10.0.0.10:3200
- **Health**: http://10.0.0.10:3200/health
- **Dashboard**: http://10.0.0.10:3200/
- **API**: http://10.0.0.10:3200/api/
