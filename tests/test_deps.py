...
def test_ext_suffix_posix_passthrough():
    assert _ext_suffix("/Users/artist/lib/b.abc") == "/Users/artist/lib/b.abc"
...
def test_pathmap_key_avoids_root_and_drive_root_keys():
    ...
    assert _pathmap_key("/Users/artist/lib", "/Users/artist/lib/b.abc") == "/Users/artist/lib"
...
def test_pathmap_env_json_shape():
    raw = pathmap_env({"/Users/artist/job": "/workspace/projects/may/shot", "/Users/artist/lib": "/workspace/projects/may/shot/_ext/Users/artist/lib"})
    data = json.loads(raw)
    assert set(data.keys()) == {"paths"}
    assert isinstance(data["paths"], list)
    entries = {k: v for e in data["paths"] for k, v in e.items()}
    assert entries["/Users/artist/job"] == {"zone": "LINUX", "path": "/workspace/projects/may/shot"}
    assert entries["/Users/artist/lib"] == {"zone": "LINUX", "path": "/workspace/projects/may/shot/_ext/Users/artist/lib"}
...
#
# On /Users/artist/BS/airship/airship_v013.hip the upload node planned 794
...
# parameter returns "/Users/artist/Downloads/airship_v06.fbx#Airship_...,convertoff",
