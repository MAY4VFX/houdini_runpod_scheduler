...
def test_houdinis_own_path_map_gets_the_same_mapping():
    env = _pathmap_env({"/Users/artist": "/workspace/projects/may/airship"})
...
def test_path_mapping_set_to_none_is_honoured():
    ...
    assert _pathmap_env({"/Users/artist": "/workspace/p"}, mapmode=1) == {}
...
def test_a_nested_root_is_not_pruned_from_houdinis_map():
    ...
    env = _pathmap_env({
        "/Users/artist": "/workspace/projects/may/airship",
        "/Users/artist/color/ocio/aces_2.0":
            "/workspace/projects/may/airship/_ext/Users/artist/color/ocio/aces_2.0",
    })
...
def test_skipped_work_is_announced_with_a_path_to_look_at():
    ...
    class _PdgNode:
        workItems = [_Item(cached_state, "/Users/artist/BS/airship/render/shot0018/f.0001.exr"),
