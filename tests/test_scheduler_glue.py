...
def test_the_task_environment_points_at_the_uploaded_colour_config(monkeypatch):
    ...
    monkeypatch.setenv("OCIO", "/Users/artist/color/ocio/aces_2.0/config.ocio")
    self = types.SimpleNamespace(
        _pathmap={"/Users/artist/color/ocio/aces_2.0": "/workspace/projects/may/shot/_ext/Users/artist/color/ocio/aces_2.0"},
        _log=lambda m: None)
    env = {}
    ...
    assert env["OCIO"] == (
        "/workspace/projects/may/shot/_ext/Users/artist/color/ocio/aces_2.0/config.ocio")
...
# file was on the pod and the node still looked for /Users/artist/...
# ---------------------------------------------------------------------------
...
def test_the_local_root_becomes_a_link_to_the_uploaded_project():
    got = _links({"/Users/artist": "/workspace/projects/may/airship"})

    assert "ln -sfn /workspace/projects/may/airship /Users/artist" in got
    assert "[ -L /Users/artist ]" in got, "replace a symlink or nothing"
    assert "[ ! -e /Users/artist ]" in got, "never a real directory"
...
def test_a_root_inside_a_linked_root_is_left_to_the_link():
    ...
    said = []
    got = _links({
        "/Users/artist": "/workspace/projects/may/airship",
        "/Users/artist/color/ocio": "/workspace/projects/may/airship/_ext/Users/artist/color/ocio",
    }, log=said.append)

    assert got.count("ln -sfn") == 1
    assert "/Users/artist/color/ocio" not in got.split("ln -sfn")[1]
    assert any("sit inside a linked root" in m for m in said), said


def test_an_external_root_outside_the_job_gets_its_own_link():
    got = _links({
        "/Users/artist/BS/airship": "/workspace/projects/may/airship",
...
def test_a_windows_local_root_is_said_out_loud_not_half_done():
    ...
    got = _links({"C:/Users/artist": "/workspace/projects/may/airship"}, log=said.append)
