...
def test_stage_tar_from_sftp_url_builds_rclone_copyto_command(tmp_path):
    ...
    local = cli._stage_tar_from_sftp_url(
        "sftp://may@workstation01/home/may/Downloads/houdini-22.0.393.tar.gz", "rclone", str(tmp_path), run=fake_run
    )
    ...
    assert cmd[2] == ":sftp,host=workstation01,user=may:/home/may/Downloads/houdini-22.0.393.tar.gz"
