...
Oracle socat → sesinetd `10.0.0.11`. Tailscale не нужен: поды не могут поднять
...
короткие служебные команды — mqserver, du, ls, rm, tar, post-команды upload).
Доступ снаружи через `https://<podId>-8000.proxy.runpod.net`.
